        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link to="/contact">
                <Button size="lg" className="bg-amana-primary hover:bg-amana-dark">
                  {t("hero.donate")}
                </Button>
              </Link>
              <Link to="/about">
                <Button variant="outline" size="lg" className="border-amana-primary text-amana-primary hover:bg-amana-light">
                  {t("hero.learnMore")}
                </Button>
              </Link>
            </div>
          ...
          <div className="relative aspect-video md:aspect-square rounded-xl overflow-hidden shadow-xl animate-fade-in animate-delay-200">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end">
              <div className="p-6 text-white">
                <p className="font-semibold">Making an impact in our community</p>
              </div>
            </div>
          </div>
        </div>
